...
Assignment:     Create a short demo application that illustrates the Strategy Design Pattern in C++.
Date:           10/26/2025
...
Educational Walkthrough Notes:
                ...
                Recruiter-facing projects may have leaner comments, but these demos are designed for clarity and education.
*/
#include <iostream>
#include <string>
#include <cctype>
